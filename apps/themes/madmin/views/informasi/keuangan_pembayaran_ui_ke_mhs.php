		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="nav nav-tabs ul-edit responsive">
					<li><a href="<?php echo Yii::app()->createUrl('/informasi/keuanganpembayarankeui', array('nama_paket'=>$this->nama_paket, 'id'=>$this->id_paket)) ?>">Pendonor ke UI</a></li>
					<li class="active"><a href="#">UI ke Penerima Beasiswa</a></li>
				</ul>
				
				<div class="tab-content responsive">
					<h4 class="mtn">Daftar Tagihan UI Ke Bagian Keuangan</h4>
					...
					<table class="table table-advanced table-hover table-striped table-bordered">
						...
						<tbody>
							<tr>
								...
								<td>1</td>
								<td><a href="<?php echo Yii::app()->createUrl('/informasi/viewpembayarankeui', array('nama_paket'=>$this->nama_paket, 'id'=>$this->id_paket)) ?>">TagKeu/1/1/2014</a></td>
								<td>Periode 1</td>
								<td>100.000.000</td>
								<td>0</td>
