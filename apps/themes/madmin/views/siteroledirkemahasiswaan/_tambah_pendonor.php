...
?>
	...
	<div class="form-group <?php echo $stateError; ?>">
		...
		<div class="col-md-5">
			<textarea class="form-control" name="Pendonor[alamat]"></textarea>
			<div class="errDiv">
				<em class="invalid" for="text">
	...
	<div class="form-group <?php echo $stateError; ?>">
		...
		<div class="col-md-5">
			<input type="text" class="form-control" name="Pendonor[no_telp_kantor]" />
			<div class="errDiv">
				<em class="invalid" for="text">
	...
	<div class="form-group <?php echo $stateError; ?>">
		...
		<div class="col-md-5">
			<input type="text" class="form-control" name="Pendonor[fax]" />
			<div class="errDiv">
				<em class="invalid" for="text">
