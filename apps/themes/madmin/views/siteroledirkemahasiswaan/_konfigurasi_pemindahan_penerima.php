...
<div class="row">
	<div class="col-lg-12">
		<h4 class="text-blue"><i class="fa fa-list-ul"></i>&nbsp;&nbsp;Daftar Paket Beasiswa Untuk Pemindahan Penerima Beasiswa</h4>
		<hr class="mts mbm">
		<br />
		<?php
...
//echo "<pre>";print_r($dataProvider);die();
		...
		'action'=>$this->createUrl('konfigurasiPemindahanPenerima'),
		'method'=>'get',
						...
						$this->widget('ext.myGridView', array(
							...
							'columns' => array(
								...
								array(
									'name' => 'Nama Paket',
									'type' => 'raw',
									'value'=>'CHtml::link($data[\'nama_paket_beasiswa\'], array("siteroledirkemahasiswaan/beranda", "idPaket"=>$data[\'id\'],"action"=>"konfigurasiPaketBeasiswa","konfig"=>"detailpemindahanpenerima"))'
								),
                                array(
                                    'name' => 'Fakultas',
                                    'type' => 'raw',
