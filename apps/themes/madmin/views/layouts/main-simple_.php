...
<div>
    ...
    <nav id="topbar" role="navigation" style="margin-bottom: 0; z-index: 2;" class="navbar navbar-default navbar-static-top">
        ...
        <div class="navbar-header hidden-xs" style="padding: 5px">
            <a id="logo" href="/apps" >
                <img src="/apps/themes/madmin/images/logo-ui-horizontal_no_frame_fordarkbackground.png">
            </a>
        </div>
        ...
        <div class="topbar-main"></a>
            <ul class="nav navbar-nav navbar-top-links horizontal-menu" style="margin-top:0px">
                        ...
                        <li>
                            <div class="mega-menu-content">
                                <div class="row">
                                    ...
                                    <ul class="col-md-4 mega-menu-submenu">
                                        <li><h3>Beranda</h3></li>
                                        <li><a href='<?php echo Yii::app()->createUrl('/site/berandapendaftar'); ?>'>Pendaftar</a></li>
                                        <?php 
                                            if (Yii::app()->session['role'] == 'pendonor') {
                                                echo "<li>";
                                                echo CHtml::link('Pendonor', array('site/berandapendonor'));
                                                echo "</li>";
                                            }
                                            if (Yii::app()->session['role'] == 'pengelola') {
                                                echo "<li>";
                                                echo CHtml::link('Pengelola', array('site/berandapengelola'));
                                                echo "</li>";
                                            }
                                            if (Yii::app()->session['role'] == 'kemahasiswaan') {
                                                echo "<li>";
                                                echo CHtml::link('Kemahasiswaan', array('site/berandakemahasiswaan'));
                                                echo "</li>";
                                            }
                                            if (Yii::app()->session['role'] == 'keuangan') {
                                                echo "<li>";
                                                echo CHtml::link('Keuangan', array('site/berandakemahasiswaan'));
                                                echo "</li>";
                                            }
                                        ?>
                                    </ul>
                ...
                <li class="hidden-xs">
					...
					-->	
						<!--
						<a href='<?php //echo Yii::app()->createUrl('/site/berandapendaftar'); ?>'>Pendaftar</a></li>
                        -->
						<?php
							/*
                            if (Yii::app()->session['role'] == 'pendonor') {
...
-->
                ...
                <li class="hidden-xs">
                    ...
                    <ul class="dropdown-menu">
						<li><a href='<?php echo Yii::app()->createUrl('/site/jadiPengelola'); ?>'>Pengelola</a></li>
                        <li><a href='<?php echo Yii::app()->createUrl('/site/jadiPendonor'); ?>'>Pendonor</a></li>
                        <li><a href='<?php echo Yii::app()->createUrl('/site/jadiKemahasiswaan'); ?>'>Kemahasiswaan</a></li>
                        <li><a href='<?php echo Yii::app()->createUrl('/site/jadiKeuangan'); ?>'>Keuangan</a></li>
						<li><a href='<?php echo Yii::app()->createUrl('/site/jadiPendaftar'); ?>'>Pendaftar</a></li>
					</ul>
                </li>
				<?php
					}
